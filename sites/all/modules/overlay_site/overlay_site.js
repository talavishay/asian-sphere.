...
jQuery('body.front #overlay_site').css({
			"background-image" : "url(/sites/all/modules/overlay_site/homepagefinal.png)", 
			"min-height" : jQuery(document).height()*2
		
});
  jQuery('body.node-type-conferences #overlay_site').css("background-image","url(/sites/all/modules/overlay_site/conferencespagefinal.png)");
